...
<tr>
	<td>Caller's Name :</td>
	<td><input type="text" namr="callerName" id="callerName"></td>	
</tr>

<tr>
	<td>Contact No :</td>
	<td><input type="text" namr="contactNo" id="contactNo"></td>	
</tr>

<tr>
	<td>Location:</td>
	<td><input type="text" namr="location" id="location"></td>	
</tr>
<tr>
	<td>Incident Type :</td>
	<td><select name="incidentType" id="incidentType"></select></td>	
</tr>
<tr>
<td>Description</td>
